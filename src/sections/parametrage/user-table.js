...
import { deleteUser } from 'src/firebase/firebaseServices';
                                        ...
                                        >
                                            ...
                                            <TableCell >
                                                <Stack
                                                    ...
                                                    spacing={2}
                                                >
                                                    <Avatar src='/assets/avatars/user3.png'/>
                                                    {user?.identifiant}
                                                </Stack>
                                            </TableCell>
                                            ...
                                            <TableCell >
                                                ...
                                                >
                                                    ...
                                                    <Typography variant="subtitle2" color={'cornflowerblue'}>
                                                        {user?.role}
                                                    </Typography>
                                                </Stack>
                                            </TableCell>
                                            ...
                                            <TableCell>
                                                <Stack direction={'row'}
                                                    ...
                                                    {/* <Fab size="small"
                                                        //color="secondary"
                                                        aria-label="edit"
                                                        onClick={(event) => handleEditClick(event, user)} disabled={!isSelected}>
                                                        <SvgIcon fontSize="small">
                                                            <PencilIcon />
                                                        </SvgIcon>
                                                    </Fab> */}
                                                    <Fab size="small" color="error" aria-label="delete"
                                                        onClick={(event) => handleDeleteClick(event, user)} disabled={!isSelected}>
                                                        <SvgIcon fontSize="small">
                                                            <TrashIcon />
                                                        </SvgIcon>
                                                    </Fab>
